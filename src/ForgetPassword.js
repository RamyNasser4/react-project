        ...
        <div className="w-full flex justify-center py-[35vh]">
            <div className="flex flex-col w-[85%] lg:w-2/5 justify-center items-start">
                ...
                <form className="flex flex-col w-full">
                    ...
                    <button type="submit" className="flex justify-start items-center text-xl font-[AwanZaman] text-white py-3 px-4 bg-black border-2 hover:bg-[#2A2A2A] duration-300 hover:border-[#2A2A2A] border-black w-full sm:w-[45%]">
